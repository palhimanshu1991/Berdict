...
class UsersController extends Controller {
    ...
    public function invite() {
        ...
        return view('users.invite',compact('left','used'));
    ...
    public function signup() {
        ...
        return view('users.signup',compact('show','error'));
    }
...
//            $invite->createCodes($insertedId);
    ...
    public function show($id) {
        ...
        return view('users.show', compact('user', 'fav', 'action', 'follow', 'follower', 'followerCount', 'following', 'followingCount', 'reviewCount','viewCount','movieCount'));
    }
    ...
    public function UserFollowers($id) {
        ...
        return view('users.followers', compact('user', 'fav', 'action', 'follow', 'follower', 'followerCount', 'following', 'followingCount', 'reviewCount'));
    }
