...
Route::get('admin/review/{id}', 'AdminController@review');
Route::post('admin/review/{id}', 'AdminController@comment');

Route::post('movie/{id}/omdbUpdate', 'MovieInfoController@omdbUpdate');
