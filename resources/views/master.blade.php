...
<html lang="en" xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml">
    <head>
        ...
        <link rel="icon" href="{{ Config::get('url.home')}}favicon.ico" sizes="32x32">
        <link rel="stylesheet" type="text/css" href="{{Config::get('url.home')}}bootstrap/css/bootstrap.css">
        <link rel="stylesheet" type="text/css" href="{{Config::get('url.home')}}bootstrap/css/docs.css">
        <link rel="stylesheet" type="text/css" href="{{ Config::get('url.home')}}rate/rateit.css">
		<link rel="stylesheet" type="text/css" href="{{Config::get('url.home')}}bootstrap/css/ionicons.min.css">
...
<!--         @if(Config::get('url.home')=='http://localhost/live/')
        ...
        <header class="navbar navbar-inverse navbar-fixed-top bs-docs-nav" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="{{Config::get('url.home')}}" class="navbar-brand"><img width="100" src="{{Config::get('url.home')}}berdict/img/p_berdict_s.png"/></a>
                </div>
                <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        @if(Auth::check())
                        <?php $base = new \App\Http\Controllers\BaseController; ?>
                        <li class="dropdown">
                        ...
                        <li rel="tooltip" data-placement="bottom" title="" data-original-title="Go to profile" class="dropdown" >
                            <a id="drop4" style="padding:0px;"  role="button"  href="{{Config::get('url.home')}}{{Auth::user()->username}}"> 
                                ...
                                <img style="width:50px;height:50px" src="{{Config::get('url.web')}}user_uploads/1000/{{Auth::user()->id}}/{{Auth::user()->usr_image}}"> 
                                @else 
                                <img style="width:50px;height:50px" src="{{Config::get('url.home')}}berdict/img/default.jpg"> 
                                @endif
                            </a>
                        </li>
                        @endif
    ...
    <div class="modal" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <script type="text/javascript" src="{{Config::get('url.home')}}bootstrap/js/bootstrap.js"></script>
        <script type="text/javascript" src="{{Config::get('url.home')}}bootstrap/js/main.js"></script>
        <script type="text/javascript" src="{{Config::get('url.home')}}berdict/js/jquery.lazyload.js"></script>

        <script src="{{Config::get('url.home')}}rate/jquery.rateit.js"></script>
        <script src="{{Config::get('url.home')}}bootstrap/js/bootstrap-dialog.min.js"></script>


        <script src="{{ Config::get('url.home')}}bootstrap/js/elastic.js"></script>
        <script type="text/javascript">
