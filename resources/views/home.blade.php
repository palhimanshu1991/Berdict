    ...
    <div class="container" style="height:100%;">
        <section class="" style="min-height:250px;"> 
            ...
            <div class="grid_16 column" align="center" style="">
                <img class="grid_8" src="{{Config::get('url.home')}}berdict/img/home_intro.jpg">
            </div>
            <div class="grid_16 column" align="center" style="">
        ...
        <div class="grid_4 column zbans omega" style="width:262px;">
                <div>
                    ...
                    <div class="sug_box" style="margin-top:10px;">	  
                        ...
                        <a href="{{Config::get('url.home')}}movie/{{$movie->fl_id}}/{{\Helpers\Helper::cleanUrl($movie->fl_name)}}" style="text-decoration:none;">
