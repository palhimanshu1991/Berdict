                                        ...
                                        <div class="grid_5 column alpha" style="width:500px;">
                                            <div class="user-snippet">
                                                <a class="left user-snippet-image" href="user.php?u=5">
                                                    <img class="lazy" src="{{Config::get('url.home')}}berdict/img/default.jpg" data-original="{{Config::get('url.home')}}user_uploads/1000/{{$user->id}}/{{$user->usr_image}}" alt="" width="50" height="50">
                                                </a>
