    ...
    <div class="row-fluid pbot ptop2" >
        <div class="col-md-12 pad0" style="text-align:center;margin:0 auto;">
            <div class="profile-card-image">
                @if($user->usr_image)
                <img class="img-responsive lazy" style="display:inline;width:160px;height:160px;border-radius:50%;border: 1px solid #ddd;" src="{{Config::get('url.home')}}berdict/img/default.jpg" data-original="{{Config::get('url.web')}}public/user_uploads/1000/{{$user->id}}/{{$user->usr_image}}"  />
                @else 
                <img class="img-responsive lazy" style="display:inline;width:160px;height:160px;border-radius:50%;border: 1px solid #ddd;" src="{{Config::get('url.home')}}berdict/img/default.jpg" data-original="{{Config::get('url.web')}}public/user_uploads/1000/{{$user->id}}/{{$user->usr_image}}"  />
                @endif
            </div>  
...
<div class="blockDivider "><a class="blockDivider-name">Latest Reviews</a></div>        
        ...
        <div id="myTabContent" class="tab-content">
            ...
            <div class="row-fluid col-md-9 pad0" style="margin-bottom:30px;" id="data-review-4477">
               <div class="res-review-user col-md-12 pad0" style="height: 50px;">
                  <a class="left" href="{{Config::get('url.home')}}{{$user->username}}">
                    <img class="lazy img-responsive " src="{{Config::get('url.home')}}berdict/img/avatar_50.png" data-original="{{Config::get('url.web')}}public/user_uploads/1000/{{$user->id}}/{{$user->usr_image}}" alt="" style="height:36px;width: 36px; display: inline;border-radius:50px;">
                  </a>
               ...
               <div class="res-review-header col-md-12 pad0" style="height:30px;">
                  ...
                  <div class="res-review-rating col-md-3 col-xs-3 pad0 hidden" style="width:80px:">
                     <img class="img-responsive" src="{{Config::get('url.home')}}rate_{{$film->fr_vote}}.jpg" alt="" style="width:42px;display: inline;float:right;">
               ...
               <div review-container="{{$film->fr_id}}" class="comment-container-{{$film->fr_id}} hidden comment-wrapper">
                  ...
                  <div class="res-review-user col-md-12 pad0" style="padding:10px 0px;border-top:1px solid #eee;">
                     <a class="left" href="{{Config::get('url.home')}}{{$reply->username}}">
                        <img class="lazy img-responsive " src="{{Config::get('url.home')}}berdict/img/avatar_50.png" data-original="{{Config::get('url.web')}}public/user_uploads/1000/{{$reply->id}}/{{$reply->usr_image}}" alt="" style="height:36px;width: 36px; display: inline;border-radius:50px;">
                     </a>
                     <div class="feed-rate-user-details">
            ...
            <div  class="col-md-3 visible-md-9 hidden-sm hidden-xs" style="margin-bottom:40px;">
                <a class="" href="{{Config::get('url.home')}}movie/{{$film->fl_id}}/{{\Helpers\Helper::cleanUrl($film->fl_name)}}"> 
                  <img class="lazy" src="{{Config::get('url.home')}}berdict/img/default_poster.jpg" data-original="{{Config::get('url.web')}}public/uploads/movie/{{$film->fl_year}}/{{$film->fl_image}}" alt="" style="display: inline;margin-left: 20px;border:1px solid #ccc;max-height: 320px;min-height: 300px;max-width: 210px;width: 205px;">             
                </a>
            </div>
            <!--- Old review -->
            <div class="row-fluid res-review" style="display:none;" id="data-review-{{$film->fr_id}}">
               <div class="res-review-user col-md-12 pad0">
                  <a class="left" href="{{Config::get('url.home')}}{{$user->username}}">
                  <img class="lazy img-responsive " src="{{Config::get('url.home')}}berdict/img/avatar_50.png" data-original="{{Config::get('url.web')}}public/user_uploads/1000/{{$user->id}}/{{$user->usr_image}}" alt="" style="height:36px;width: 36px; display: inline;">
                  </a>
                  <div class="feed-rate-user-details">
                     <a href="{{Config::get('url.home')}}{{$user->username}}">{{$user->usr_fname}}</a> <span class="helper"> wrote a berdict for </span> <a href="{{Config::get('url.home')}}movie/{{$film->fl_id}}/{{\Helpers\Helper::cleanUrl($film->fl_name)}}">{{$film->fl_name}}</a> 
                  </div>
               </div>
                  ...
                  <div class="res-review-header col-md-12 pad0" style="min-height:90px;">
                     ...
                     <div class="res-review-user col-md-8 pad0" style="min-height:90px;width:500px">
                        <div data-review-id="{{$film->fr_id}}" class="res-review-body review-profile feed-review-body">
                           <img width="16px" style="margin-top:-5px;" src="{{Config::get('url.home')}}berdict/img/quote_b.png">
                           {{$film->fr_review}}
                        </div>
                     </div>
            ...
            <div class="tab-pane fade" id="latest">
                <div id="myLatestLoading" style="display: none;padding:20px;text-align: center;"><img src="{{Config::get('url.home')}}berdict/img/progress.gif"/>Loading.....</div>
            </div>
        </div>
    </div>
</div>
...
@section('extra')
<script src="{{Config::get('url.home')}}bootstrap/js/jquery.jcarousel.min.js"></script>
<script src="{{Config::get('url.home')}}bootstrap/js/jcarousel.skeleton.js"></script>
<style type="text/css">
