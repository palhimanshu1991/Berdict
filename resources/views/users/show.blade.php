    ...
    <div class="row-fluid pbot ptop2" >
        <div class="col-md-12 pad0" style="text-align:center;margin:0 auto;">
            <div class="profile-card-image">
                @if($user->usr_image)
                <img class="img-responsive lazy" style="display:inline;width:160px;height:160px;border-radius:50%;border: 1px solid #ddd;" src="{{Config::get('url.home')}}berdict/img/default.jpg" data-original="{{Config::get('url.web')}}user_uploads/1000/{{$user->id}}/{{$user->usr_image}}"  />
                @else 
                <img class="img-responsive lazy" style="display:inline;width:160px;height:160px;border-radius:50%;border: 1px solid #ddd;" src="{{Config::get('url.home')}}berdict/img/default.jpg" data-original="{{Config::get('url.web')}}user_uploads/1000/{{$user->id}}/{{$user->usr_image}}"  />
                @endif
            </div>  
        ...
        <div id="myTabContent" class="tab-content">
            ...
            <div  class="col-md-3 visible-md-9 hidden-sm hidden-xs" style="margin-bottom:40px;">
                <a class="" href="{{Config::get('url.home')}}movie/{{$film->fl_id}}/{{\Helpers\Helper::cleanUrl($film->fl_name)}}"> 
                  <img class="lazy" src="{{Config::get('url.home')}}berdict/img/default_poster.jpg" data-original="{{Config::get('url.web')}}uploads/movie/{{$film->fl_year}}/{{$film->fl_image}}" alt="" style="display: inline;margin-left: 20px;border:1px solid #ccc;max-height: 320px;min-height: 300px;max-width: 210px;width: 205px;">             
                </a>
            </div>
            <!--- Old review -->
            <div class="row-fluid res-review" style="display:none;" id="data-review-{{$film->fr_id}}">
               <div class="res-review-user col-md-12 pad0">
                  <a class="left" href="{{Config::get('url.home')}}{{$user->username}}">
                  <img class="lazy img-responsive " src="{{Config::get('url.home')}}berdict/img/avatar_50.png" data-original="{{Config::get('url.web')}}user_uploads/1000/{{$user->id}}/{{$user->usr_image}}" alt="" style="height:36px;width: 36px; display: inline;">
                  </a>
                  <div class="feed-rate-user-details">
