                            ...
                            <li>
                                <div class="feed-gallery left" rel="popover" data-original-title="{{$movie->fl_name}}" data-container="body" data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="{{$movie->fl_outline}}" style="">									
                                    <a href="{{ Config::get('url.home')}}movie/{{$movie->fl_id}}/{{\Helpers\Helper::cleanUrl($movie->fl_name)}}">
                                        <img class="lazy img-responsive" src="{{ Config::get('url.home')}}berdict/img/default_poster.jpg" data-original="{{ Config::get('url.home')}}uploads/movie/{{$movie->fl_year}}/{{$movie->fl_image}}">
                                    </a>
                                </div>	               
                            </li>
                            @endforeach
                    ...
                    <div class="res-review-header feed-action col-md-12 pad0" style="">
                        <div class="res-review-header col-md-12 pad0" style="width:100%;height:90px;">
                            ...
                            <div class="res-review-rating col-md-2 pad0">
                                <img class="img-responsive" src="{{Config::get('url.home')}}rate_{{$film->rt_vote}}.jpg" alt="" style="width:48px;display: inline;float:right;">
            ...
            <div class="row-fluid col-md-9 pad0" style="margin-bottom:30px;" id="data-review-4477">
               <div class="row" style="margin:0px;">
                 <div class="res-review-user col-md-9 col-xs-9 pad0" style="height: 50px;">
                    <a class="left" href="{{Config::get('url.home')}}{{$action->username}}">
                      <img class="lazy img-responsive " src="{{Config::get('url.home')}}berdict/img/avatar_50.png" data-original="{{Config::get('url.web')}}public/user_uploads/1000/{{$action->id}}/{{$action->usr_image}}" alt="" style="height:36px;width: 36px; display: inline;border-radius:50px;">
                    </a>
                    <div class="feed-rate-user-details">
