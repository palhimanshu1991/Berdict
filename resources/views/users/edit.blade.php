            ...
            <div class="dialog-head-container clearfix" style="background:none;border-bottom: 0px solid #e4e4e2;">
                <div class="left" style="width:210px;">
                    ...
                    <div class="col-sm-12 pad0" style="margin-right:0px;">
                        <img src="{{Config::get('url.home')}}user_uploads/1000/{{ $user->id }}/{{ $user->usr_image }}" width="90" height="90" style="box-shadow: 0px 0px 1px #a8a8a8;">
                    </div><br/>
...
<!-- add extra styles -->
<link href="{{Config::get('url.home')}}crop/css/main.css" rel="stylesheet" type="text/css" />
<link href="{{Config::get('url.home')}}crop/css/jquery.Jcrop.min.css" rel="stylesheet" type="text/css" />
<!-- add extra scripts -->
<script src="{{Config::get('url.home')}}crop/js/jquery.min.js"></script>
<script src="{{Config::get('url.home')}}crop/js/jquery.Jcrop.min.js"></script>
<script src="{{Config::get('url.home')}}crop/js/script.js"></script>   
