    ...
    <div class="res-review-header col-md-12 pad0" style="">
        <div class="res-review-header col-md-12 pad0" style="width:100%;height:48px;">
            <div class="res-review-user col-md-6 pad0">
                <a class="left" href="{{Config::get('url.home')}}{{$user->username}}">
                    @if($user->usr_image)
					<img class="lazy img-responsive " src="{{Config::get('url.home')}}user_uploads/1000/{{$user->id}}/{{$user->usr_image}}"  alt="" style="width: 48px; display: inline;">
					@else
            ...
            <div class="res-review-rating col-md-6 pad0">
                <img class="img-responsive" src="{{Config::get('url.home')}}rate_{{$latest->fr_vote}}.jpg" alt="" style="width:48px;display: inline;float:right;">
