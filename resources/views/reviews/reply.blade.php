<div class="res-review-user col-md-12 pad0" style="padding:10px 0px;border-top:1px solid #eee;">
   <a class="left" href="{{Config::get('url.home')}}{{Auth::user()->username}}">
      <img class="lazy img-responsive " src="{{Config::get('url.home')}}berdict/img/avatar_50.png" data-original="{{Config::get('url.web')}}public/user_uploads/1000/{{Auth::user()->id}}/{{Auth::user()->usr_image}}" alt="" style="height:36px;width: 36px; display: inline;border-radius:50px;">
   </a>
