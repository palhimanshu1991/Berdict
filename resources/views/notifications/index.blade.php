                            ...
                            <div class="grid_5 column alpha" style="width:600px;">
                                <div class="user-snippet">
                                    <a class="left user-snippet-image" href="{{Config::get('url.home')}}{{$user->username}}">
                                        <img class="lazy" src="{{Config::get('url.home')}}berdict/img/default.jpg" data-original="{{Config::get('url.home')}}user_uploads/1000/{{$user->id}}/{{$user->usr_image}}" alt="" width="" height="" style="display: inline;">
                                    </a>
