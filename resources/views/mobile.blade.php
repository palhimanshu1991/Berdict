...
<link href="{{Config::get('url.home')}}bootstrap/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="{{Config::get('url.home')}}mobile/new/css/style.css" rel="stylesheet" type="text/css" media="all" />
<link href="{{Config::get('url.home')}}mobile/new/css/animate.css" rel="stylesheet" type="text/css" media="all" />


<script src="{{Config::get('url.home')}}mobile/js/jquery-1.8.0.min.js" type="text/javascript"></script>

<script type="text/javascript" src="{{Config::get('url.home')}}mobile/js/move-top.js"></script>

<script type="text/javascript" src="{{Config::get('url.home')}}mobile/js/easing.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="{{Config::get('url.home')}}mobile/css/slick.css" />
    <script type="text/javascript" src="{{Config::get('url.home')}}mobile/js/slick.js"></script>
    <script type="text/javascript">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="mobile-divise">
								<img src="{{Config::get('url.home')}}mobile/new/images/iphone.png">
							</div>
						</div>
						<div class="col-md-6">
