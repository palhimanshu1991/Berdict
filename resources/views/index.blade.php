...
<header class="navbar navbar-inverse navbar-fixed-top bs-docs-nav" role="banner">
    <div class="container">
        <div class="navbar-header">
            ...
            <a href="{{Config::get('url.home')}}" class="navbar-brand"><img width="100" src="{{Config::get('url.home')}}berdict/img/w_berdict_s.png"></a>
        </div>
        ...
        <div class="col-md-4">
            ...
            <div id="signup_loading" class="col-lg-12" align="" style="display:none;margin-top:12%">
                <div class="" align="center">
                    <img class="" src="{{Config::get('url.home')}}berdict/img/progress.gif">
                </div> 
