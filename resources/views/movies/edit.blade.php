...
<div class="res-imagery-default imagery item-to-hide-parent">
    <section class="res-main res-imagery-tshadow container clearfix pbot" style="padding: 0px 0px 20px 0px;">
        <a href="{{Config::get('url.home')}}movie/{{ $movie->fl_id}}/{{\Helpers\Helper::cleanUrl($movie->fl_name)}}">  <input type="button"  value="Back to Movie" class="btn btn-red left" style="margin-right:10px; margin-top:5px;" /> </a>	
    </section>
</div>
