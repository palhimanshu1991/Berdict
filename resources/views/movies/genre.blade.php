                    ...
                    <li class="resZS search-result bb  status1" data-res_id="" style="display: list-item;margin: 15px 0px;">
                        <article class="">
                            <div class="grid_8 pos-relative column " style="width: 150px;margin: 0 10px 0px 0px;">
                                <img class="lazy" src="{{Config::get('url.home')}}berdict/img/default_poster.jpg" data-original="{{Config::get('url.home')}}uploads/movie/{{$movie->fl_year}}/{{$movie->fl_image}}" width="145px" height="215px">
                            </div>
